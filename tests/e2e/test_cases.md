...
- By default, e2e tests execute against a gateway with a TLS certificate generated by a private CA. The suite setup sets `caCertBundleRef` on the MCPGatewayExtension to that CA (written to config as `gatewayCACertPEM`). The 2025-11-25 hairpin client uses the same bundle. Any 2025 `tools/call` exercises the HTTPS hairpin init path as a side effect. 2026-07-28 calls do not hairpin.

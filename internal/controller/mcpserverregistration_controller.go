...
const (
	...
	// can't enforce the rails this registration requires
...
// mcpServerRegistrationPredicate reconciles on generation changes plus the
// guardrails annotation, which doesn't bump generation.
